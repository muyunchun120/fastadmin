<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:91:"D:\phpStudy\PHPTutorial\WWW\fastadmin\public/../application/admin\view\goods\goods\add.html";i:1513869911;s:90:"D:\phpStudy\PHPTutorial\WWW\fastadmin\public/../application/admin\view\layout\default.html";i:1512802482;s:87:"D:\phpStudy\PHPTutorial\WWW\fastadmin\public/../application/admin\view\common\meta.html";i:1512802482;s:89:"D:\phpStudy\PHPTutorial\WWW\fastadmin\public/../application/admin\view\common\script.html";i:1512802482;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-goods_id" class="control-label col-xs-12 col-sm-2"><?php echo __('Goods_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-goods_id" data-rule="required" class="form-control" name="row[goods_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label for="c-goods_name" class="control-label col-xs-12 col-sm-2"><?php echo __('goods_name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-goods_name" data-rule="required" class="form-control" name="row[goods_name]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label for="c-goods_cas" class="control-label col-xs-12 col-sm-2"><?php echo __('goods_cas'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-goods_cas" data-rule="required" class="form-control" name="row[goods_cas]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label for="c-standards" class="control-label col-xs-12 col-sm-2"><?php echo __('standards'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-standards" data-rule="required" class="form-control" name="row[standards]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label for="c-goods_cas" class="control-label col-xs-12 col-sm-2"><?php echo __('goods_cas'); ?>:</label>
...
<div class="form-group">
    ...
    <div class="col-xs-12 col-sm-8">
        <input checked="" id="c-switch" name="row[switch]" type="hidden" value="0"><label for="row[switch]-switch"><input id="row[switch]-switch" name="row[switch]" type="checkbox" value="1"> abcdefg</label>
    </div>
</div>
<div class="form-group">
